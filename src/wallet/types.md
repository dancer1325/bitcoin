* == public enum + struct type definitions
  * ❌NOT have external dependencies❌
  * ⚠️out of the scope⚠️
    * MORE complicated public wallet types
      * -> place | dedicated ".h"
      * _Example:_ `CCoinControl` 
* uses
  * internally -- by -- wallet code
  * externally -- by -- node OR GUI code

* `namespace wallet {`
  * `enum isminetype : unsigned int {`
    * == codes / 
      * depend on `ScriptPubKeyMan` implementation
        * ❌[NOT ALL `ScriptPubKeyMan` covers ALL types](../../doc/release-notes/release-notes-0.21.0.md#ismine-semantics)❌
